...
export default function Dashboard() {
  ...
  const STAT_CARDS = [
    { label: 'Total Registered Users', value: stats?.users, icon: '👥', color: '#6366f1' },
    { label: 'Institutions & Companies', value: stats?.institutions, icon: '🏛️', color: '#059669' },
    { label: 'Pending Approvals', value: totalPending, icon: '⏳', color: totalPending > 0 ? '#ef4444' : '#10b981', badge: totalPending > 0 ? 'ACTION NEEDED' : 'CLEAR' },
    { label: 'Live Course & Univ Listings', value: stats?.universities, icon: '🎓', color: '#3b82f6' },
    { label: 'Live Corporate Jobs', value: stats?.jobs, icon: '💼', color: '#8b5cf6' },
    { label: 'Internship Listings (Stages)', value: stats?.stages, icon: '📋', color: '#d97706' },
  ];
